...
public class CableTypes extends ActionBarActivity {
    ...
    public String[][] cables(int freq){
        ...
        String[][] cableproperties = {
                {"LDF4", "" + ldf4loss(freq), "24.3"},
                {"FSJ4", "" + fsj4loss(freq), "20.8"},
                {"CR540", "" + cr540loss(freq), "26.4"},
                {"LDF5", "" + ldf5loss(freq), "24.3"},
                {"LDF6", "" + ldf6loss(freq), "24.3"},
                {"CR1070", "" + cr1070loss(freq), "26.4"},
                {"LDF7", "" + ldf7loss(freq), "24.3"},
                {"AVA7", "" + ava7loss(freq), "24.3"},
                {"AVA6", "" + ava6loss(freq), "24.3"},
                {"AVA5", "" + ava5loss(freq), "24.3"}
        };
